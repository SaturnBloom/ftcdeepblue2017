...
public class JIU_HardwareBHA_Test
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        glimpseLServo = hwMap.servo.get("beacon_servo");
        glimpseRServo = hwMap.servo.get("ball_servo");
        ...
        glimpseLServo.setPosition(200); //Set position to top/middle

        glimpseRServo.scaleRange(1,250);
        glimpseRServo.setPosition(100); //Set position to low-state inside the lift
